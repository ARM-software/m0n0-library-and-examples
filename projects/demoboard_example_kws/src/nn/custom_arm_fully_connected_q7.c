...
/*Dummy function to avoid pB to be badly computed*/
const q7_t * dummy_function(const q7_t * pB){
  return pB;
}
                       ...
                       const uint16_t out_shift, const q7_t * bias, q7_t * pOut, q15_t * vec_buffer)
{
    ...
    // m0n0_printf("arm_q7_to_q15_reordered_no_shift start\n");
    arm_q7_to_q15_reordered_no_shift(pV, vec_buffer, dim_vec);
    // m0n0_printf("arm_q7_to_q15_reordered_no_shift done\n");
    while (rowCnt)
    {


        // m0n0_printf("rowCnt: %d \n", rowCnt);
        // m0n0_printf("dim_vec: %d \n", dim_vec);
        // m0n0_printf("pB: %x \n", pB);
        ...
        *pO++ = (q7_t) (__SSAT((sum2 >> out_shift), 8));
        ...
        // m0n0_printf("pB>>%x,\n", pB);
        /*Call to a dummy function to avoid pB to be badly computed*/
        pB = dummy_function(pB);
        pB += dim_vec;
        rowCnt--;
        // m0n0_printf("rowCnt->%d,\n", rowCnt);
        // m0n0_printf("pB->%x,\n", pB);
